...
export default function HowToUse() {
  ...
  const steps = [
    { title: dict.howToUse.step1Title, description: dict.howToUse.step1Desc },
    { title: dict.howToUse.step2Title, description: dict.howToUse.step2Desc },
    { title: dict.howToUse.step3Title, description: dict.howToUse.step3Desc },
  ];
